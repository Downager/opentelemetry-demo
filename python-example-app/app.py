...
opentelemetry_resource = opentelemetry.sdk.resources.Resource(attributes={"service.name": "python-example-app"})
...
driver = GraphDatabase.driver("neo4j+s://1e02c965.databases.neo4j.io", auth=basic_auth("neo4j", "zbvV0gWwxbcXrnlIgoAy_LpzZTvc2PatWuKiA0fDsSc"))
